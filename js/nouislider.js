...
!(function (a) {
    ...
    function c(a) {
        var b = a.getBoundingClientRect(),
            ...
            e = c.documentElement,
            f = d.pageXOffset;
        return /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (f = 0), { top: b.top + d.pageYOffset - e.clientTop, left: b.left + f - e.clientLeft };
    }
    function d(a) {
    ...
    function J(a) {
        var b,
            c = { margin: 0, limit: 0, animate: !0, format: U };
        b = {
            step: { r: !1, t: x },
            start: { r: !0, t: z },
            connect: { r: !0, t: C },
    ...
    function L(a) {
        ...
        return (
            ...
            (e || f) && ((b = a.clientX + window.pageXOffset), (c = a.clientY + window.pageYOffset)),
            (g.points = [b, c]),
            (g.cursor = e || f),
            g
        );
    ...
    function Q(b, d) {
        ...
        function v(a, b) {
            ...
            a.stopPropagation();
            var d = s(S.move, c, t, { start: a.calcPoint, handles: b.handles, positions: [J[0], J[H.length - 1]] }),
        ...
        function w(a) {
            ...
            return (
                ...
                (b = h / 2 > g || 1 === H.length ? 0 : 1),
                (g -= c(G)[d.style]),
                (e = (100 * g) / p()),
                d.events.snap || f(I, T[14], 300),
                H[b].hasAttribute("disabled") ? !1 : (y(H[b], e), q("slide", b), q("set", b), q("change", b), void (d.events.snap && v(a, { handles: [H[h]] })))
            );
        }
        function x(a) {
            var b, c;
            if (!a.fixed) for (b = 0; b < H.length; b += 1) s(S.start, H[b].children[0], v, { handles: [H[b]] });
            a.tap && s(S.start, G, w, { handles: H }),
                a.drag &&
                    ((c = [G.getElementsByClassName(T[7])[0]]),
                    j(c[0], T[10]),
                    a.fixed && c.push(H[c[0] === H[0] ? 1 : 0].children[0]),
        ...
        function y(a, b, c) {
            var e = a !== H[0] ? 1 : 0,
                ...
                l = J[1] - d.limit;
            return (
                H.length > 1 && (b = e ? Math.max(b, f) : Math.min(b, h)),
                c !== !1 && d.limit && H.length > 1 && (b = e ? Math.min(b, i) : Math.max(b, l)),
                (b = M.getStep(b)),
                (b = g(parseFloat(b.toFixed(7)))),
                b === J[e] ? !1 : ((a.style[d.style] = b + "%"), a.previousSibling || (k(a, T[17]), b > 50 && j(a, T[17])), (J[e] = b), (Q[e] = M.fromStepping(b)), q("update", e), !0)
            );
        }
        function z(a, b) {
            var c, e, f;
            for (d.limit && (a += 1), c = 0; a > c; c += 1)
                (e = c % 2), (f = b[e]), null !== f && f !== !1 && ("number" == typeof f && (f = String(f)), (f = d.format.from(f)), (f === !1 || isNaN(f) || y(H[e], M.toStepping(f), c === 3 - d.dir) === !1) && q("update", e));
        }
        function A(a) {
            var b,
                c,
        ...
        return (G = P(d.dir, d.ort, I)), (H = O(d.handles, d.dir, G)), N(d.connect, I, H), x(d.events), d.pips && o(d.pips), { destroy: C, steps: D, on: E, off: F, get: B, set: A };
    }
    function R(a, b) {
