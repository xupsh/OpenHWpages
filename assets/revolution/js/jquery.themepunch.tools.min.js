    ...
    if (!i.TweenLite) {
                                ...
                                n
                                    ? "string" != typeof n
                                        ? n.length && n !== t && n[0] && (n[0] === t || (n[0].nodeType && n[0].style && !n.nodeType))
                                            ...
                                            : ((this._siblings[r] = W(n, this, !1)), 1 === l && this._siblings[r].length > 1 && Y(n, this, null, 1, this._siblings[r]))
        ...
        var z = [],
                    ...
                    (_ = n[o]),
                        ...
                        _ === r[o] || o >= r.length
                            ...
                            : (c && (u.push(c), (c = "")),
                              (a = parseFloat(r[o])),
                              u.push(a),
                              (u._firstPT = { _next: u._firstPT, t: u, p: u.length - 1, s: a, c: ("=" === _.charAt(1) ? parseInt(_.charAt(0) + "1", 10) * parseFloat(_.substr(2)) : parseFloat(_) - a) || 0, f: 0, r: m && 4 > m })),
                        (f += _.length);
            ...
            j = function (t, e, i, s, r, n, a, o) {
                ...
                return (
                    "number" !== u &&
                        ("function" === u && "get" === i && ((h = e.indexOf("set") || "function" != typeof t["get" + e.substr(3)] ? e : "get" + e.substr(3)), (c.s = _ = a ? t[h](a) : t[h]())),
                        "string" == typeof _ && (a || isNaN(_))
                            ? ((c.fp = a), (l = U(_, s, o || I.defaultStringFilter, c)), (c = { t: l, p: "setRatio", s: 0, c: 1, f: 2, pg: 0, n: r || e, pr: 0 }))
                ...
                for (n = r.length; --n > -1; )
                    (o = r[n]) === e ||
                        ...
                        (o._timeline !== e._timeline
                            ...
                            : u >= o._startTime && o._startTime + o.totalDuration() / o._timeScale > u && (((m || !o._initted) && 2e-10 >= u - o._startTime) || (f[c++] = o)));
                for (n = c; --n > -1; )
        ...
        (n._init = function () {
            ...
            if (
                ((this._ease = h = h ? (h instanceof y ? h : "function" == typeof h ? new y(h, n.easeParams) : w[h] || I.defaultEase) : I.defaultEase),
                ...
                he = (a.parseColor = function (t, e) {
                    ...
                    return (
                        e &&
                            ...
                            (u = Math.min(r, s, n)),
                            (l = (h + u) / 2),
                            h === u ? (a = o = 0) : ((f = h - u), (o = l > 0.5 ? f / (2 - h - u) : f / (h + u)), (a = h === r ? (s - n) / f + (n > s ? 6 : 0) : h === s ? (n - r) / f + 2 : (r - s) / f + 4), (a *= 60)),
                            (i[0] = 0 | (a + 0.5)),
                            (i[1] = 0 | (100 * o + 0.5)),
                            (i[2] = 0 | (100 * l + 0.5))),
                        i
            ...
            var ce = function (t, e, i, r) {
                ...
                ge = (a.parseComplex = function (t, e, i, r, s, n, a, o, l, h) {
                    ...
                    var f,
                        ...
                        R = u !== !1;
                    for (
                        (-1 !== r.indexOf(",") || -1 !== i.indexOf(",")) && ((O = O.join(" ").replace(D, ", ").split(" ")), (C = C.join(" ").replace(D, ", ").split(" ")), (k = O.length)),
                    ...
                    return (
                        ...
                        i || 0 === o || a.plugin
                            ? (a.l++,
                              ...
                              (a["xs" + a.l] = r || ""),
                              o > 0
                                  ? ((a.data["xn" + o] = e + i), (a.rxp["xn" + o] = s), (a["xn" + o] = e), a.plugin || ((a.xfirst = new de(a, "xn" + o, e, i, a.xfirst || a, 0, a.n, s, a.pr)), (a.xfirst.xs0 = 0)), a)
                ...
                Ie = (E.set3DTransformRatio = E.setTransformRatio = function (t) {
                            ...
                            C || S.skewX || z
                                ? ((C *= L),
                                  ...
                                  z &&
                                      ...
                                      we && (S.xPercent || S.yPercent) && ((d = this.t.getBBox()), (N += 0.01 * S.xPercent * d.width), (F += 0.01 * S.yPercent * d.height)),
                                      (d = 1e-6),
                                      d > N && N > -d && (N = 0),
                                      d > F && F > -d && (F = 0)),
                    ...
                    (h = 1),
                        ...
                        (p || z) &&
                            ...
                            z && ((N += S.xOrigin - (S.xOrigin * e + S.yOrigin * i) + S.xOffset), (F += S.yOrigin - (S.xOrigin * s + S.yOrigin * n) + S.yOffset)),
                            d > N && N > -d && (N = w),
                            d > F && F > -d && (F = w),
                            d > X && X > -d && (X = 0)),
                    ...
                    "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
                    {
                        parser: function (t, e, i, r, n, o, l) {
                            ...
                            var h,
                                ...
                                S = "transformOrigin";
                            if (
                                (l.display ? ((c = Q(t, "display")), (x.display = "block"), (h = ze(t, s, !0, l.parseTransform)), (x.display = c)) : (h = ze(t, s, !0, l.parseTransform)),
                                (r._transform = h),
                                ...
                                "string" == typeof b.x && -1 !== b.x.indexOf("%") && ((u.x = 0), (u.xPercent = ne(b.x, h.xPercent))),
                                    ...
                                    Ce &&
                                        ((u.rotationX = ae("rotationX" in b ? b.rotationX : "shortRotationX" in b ? b.shortRotationX + "_short" : h.rotationX || 0, h.rotationX, "rotationX", P)),
                            ...
                            return (
                                ...
                                h.svg &&
                                    ...
                                    (g !== h.xOffset || v !== h.yOffset) && ((n = me(h, "xOffset", y ? g : h.xOffset, h.xOffset, n, S)), (n = me(h, "yOffset", y ? v : h.yOffset, h.yOffset, n, S))),
                                    (_ = we ? null : "0px 0px")),
                                (_ || (Ce && p && h.zOrigin)) &&
                                    (Pe
                                        ? ((d = !0),
                            ...
                            T = 3 === this._transformType,
                                Pe
                                    ? c &&
                                      ...
                                      p && this._addLazySet(b, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (T ? "visible" : "hidden")))
                                    : (b.zoom = 1),
                                d = _;
                            d && d._next;
                                ...
                                : ((c = Q(t, a, s) + ""),
                                  ...
                                  "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || (m && P.test(_))
                                      ...
                                      ? ((h = parseFloat(c)),
                                        ...
                                        ("" === c || "auto" === c) &&
                                            ("width" === a || "height" === a ? ((h = ie(t, a, s)), (p = "px")) : "left" === a || "top" === a ? ((h = $(t, a, s)), (p = "px")) : ((h = "opacity" !== a ? 0 : 1), (p = ""))),
                                        (g = m && "=" === _.charAt(1)),
                                        ...
                                        p !== d &&
                                            ...
                                            h &&
                                            ((h = Z(t, a, h, p)),
                                            "%" === d ? ((h /= Z(t, a, 100, "%") / 100), e.strictUnits !== !0 && (c = h + "%")) : "em" === d || "rem" === d ? (h /= Z(t, a, 1, d)) : "px" !== d && ((f = Z(t, a, f, d)), (d = "px")),
                                            g && (f || 0 === f) && (_ = f + h + d)),
                                        g && (f += h),
                                        (!h && 0 !== h) || (!f && 0 !== f)
                                            ? void 0 !== v[a] && (_ || ("NaN" != _ + "" && null != _))
                                                ? ((i = new de(v, a, f || h || 0, 0, i, -1, a, !1, 0, c, _)), (i.xs0 = "none" !== _ || ("display" !== a && -1 === a.indexOf("Style")) ? _ : c))
                                                : j("invalid " + a + " tween value: " + e[a])
                                            : ((i = new de(v, a, h, f - h, i, 0, a, u !== !1 && ("px" === d || "zIndex" === a), 0, c, _)), (i.xs0 = d)))
        ...
        y = function (t, e, i, s, o) {
                ...
                for (d = 0; h > d; d++)
                    (b = w[d]),
                        ...
                        (f || L || (M && !D)) &&
                            ...
                            A && ((D !== f && M) || (_.push(b), (b._x -= E)), f && d && (w[d - 1]._wordEnd = !0), "BR" === b.nodeName && b.nextSibling && "BR" === b.nextSibling.nodeName && A.push([])));
            for (d = 0; h > d; d++)
                (b = w[d]),
                    (f = b.parentNode === t),
                    "BR" !== b.nodeName
            ...
            if (A) {
                ...
                for (C = !L || (!D && !M), d = 0; A.length > d; d++) {
                    for (
                        _ = A[d], P = n.createElement("div"), P.style.cssText = "display:block;text-align:" + U + ";position:" + (L ? "absolute;" : "relative;"), Z && (P.className = Z + (W ? d + 1 : "")), te.push(P), h = _.length, y = 0;
                        h > y;
                        y++
                    )
                        "BR" !== _[y].nodeName &&
                            ...
                            L && (0 === y && ((P.style.top = b._y + "px"), (P.style.left = E + x + "px")), (b.style.top = "0px"), x && (b.style.left = b._x - x + "px")));
