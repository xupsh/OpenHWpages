 ...
 !(function () {
    ...
    jQuery.extend(!0, e, {
        ...
        organiseCarousel: function (e, i, t, a) {
            ...
            for (var s = e.carousel, l = new Array(), o = s.slides.length, r = "right" === s.horizontal_align ? (r = e.width) : 0, n = 0; o > n; n++) {
                ...
                "on" === s.infinity && ((d = d > s.wrapwidth - s.inneroffset && "right" == i ? s.slide_offset - (s.slides.length - n) * s.slide_width : d), (d = d < 0 - s.inneroffset - s.slide_width && "left" == i ? d + s.maxwidth : d)),
                    (l[n] = d);
            }
            var f = 999;
            s.slides &&
                jQuery.each(s.slides, function (a, r) {
                    ...
                    void 0 !== s.maxRotation &&
                        ...
                        ("on" === s.vary_rotation
                            ? ((d.rotationY = Math.abs(s.maxRotation) - Math.abs((1 - Math.abs((1 / Math.ceil(s.maxVisibleItems / w)) * h)) * s.maxRotation)), (d.autoAlpha = Math.abs(d.rotationY) > 90 ? 0 : d.autoAlpha))
    ...
    var i = function (e) {
            ...
            (i.infbackup = i.infinity),
                ...
                0 !== i.maxRotation &&
                    ("3D" != e.parallax.type && "3d" != e.parallax.type ? punchgs.TweenLite.set(i.wrap, { perspective: 1200, transformStyle: "flat" }) : punchgs.TweenLite.set(i.wrap, { perspective: 1600, transformStyle: "preserve-3d" })),
        ...
        t = function (t) {
            ...
            ("3D" == t.parallax.type || "3d" == t.parallax.type) && (o = "visible"),
                "right" === a.horizontal_align
                    ? punchgs.TweenLite.set(a.wrap, { left: "auto", right: a.wrapoffset + "px", width: a.wrapwidth, overflow: o })
                    : punchgs.TweenLite.set(a.wrap, { right: "auto", left: a.wrapoffset + "px", width: a.wrapwidth, overflow: o }),
