 ...
 !(function (a) {
    ...
    jQuery.extend(!0, t, {
        ...
        animateSingleCaption: function (a, n, r, u, w, y, b) {
            ...
            if (
                ("off" == Q || (k < n.hideCaptionAtLimit && "on" == a.data("captionhidden")) || k < n.hideAllCaptionAtLimit ? a.addClass("tp-hidden-caption") : a.removeClass("tp-hidden-caption"),
            ...
            b ||
                ("reset" == sa && "bytrigger" != pa
                    ...
                    : "reset" == sa && "bytrigger" == pa && (a.data("triggerstate", "off"), a.data("animdirection", "out"), (la = "off"))),
                ...
                a.data("timeline", wa),
                    ...
                    (0 !== fa && 2 != T) ||
                        ...
                        (void 0 == ha || (-1 != T && 2 != T) || "bytriger" === ha
                            ...
                            : punchgs.TweenLite.delayedCall(parseInt(a.data("end"), 0) / 1e3, t.endMoveCaption, [a, C, L, n], n.sliderscrope)),
                    (wa = a.data("timeline")),
                    ...
                    ("sliderenter" != pa || ("sliderenter" == pa && n.overcontainer)) &&
                        ...
                        ((1 > fa && fa > 0) || (0 == fa && "bytrigger" != pa && "keep" != sa) || (0 == fa && "bytrigger" != pa && "keep" == sa && "on" == la) || ("bytrigger" == pa && "keep" == sa && "on" == la)) &&
        ...
        v = function (a, e, t, i) {
            ...
            if (("off" === i && ((r = 1), (d = 1)), "auto" == o.lineHeight && (o.lineHeight = o.fontSize + 4), !a.hasClass("tp-splitted"))) {
                ...
                if (
                    ...
                    punchgs.TweenLite.set(a, { maxWidth: h, maxHeight: c, minWidth: v, minHeight: f, whiteSpace: o.whiteSpace, overwrite: "auto" }),
