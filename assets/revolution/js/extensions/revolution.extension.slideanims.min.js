                ...
                if (
                    ...
                    8 == m
                        ? (f.add(punchgs.TweenLite.set(l, { zIndex: 20 }), 0),
                          ...
                          f.add(punchgs.TweenLite.set(ie, { left: 0, top: 0, scale: 1, opacity: 1, rotation: 0, ease: T, force3D: "auto" }), 0))
                        : f.add(punchgs.TweenLite.from(ie, oe, { left: U, top: W, scale: ee, opacity: $, rotation: r.rotate, ease: T, force3D: "auto" }), 0),
                    (4 == m || 5 == m) && ((F = 0), (G = 0)),
                    1 != m)
                )
                    switch (t) {
                    ...
                    null != l.html() &&
                        f.add(
                            punchgs.TweenLite.fromTo(
                                s,
                                (y - 200) / 1e3,
                                { scale: pe, x: (r.width / 4) * de, y: (G / 4) * he, rotation: le, force3D: "auto", transformOrigin: "center center", ease: z },
                    ...
                    d.find(".slotslide").each(function (t) {
                        ...
                        j.add(
                            punchgs.TweenLite.fromTo(
                                e,
                                y / 1e3,
                                { transformStyle: "flat", backfaceVisibility: "hidden", left: 0, rotationY: r.rotate, z: 10, top: 0, scale: 1, force3D: "auto", transformPerspective: 600, transformOrigin: ge, rotationX: ue },
                        ...
                        1 == g && (o = 90),
                            j.add(
                                punchgs.TweenLite.fromTo(
                                    e,
                                    y / 1e3,
                                    { transformStyle: "flat", backfaceVisibility: "hidden", autoAlpha: 1, rotationY: 0, top: 0, z: 0, scale: 1, force3D: "auto", transformPerspective: 600, transformOrigin: ge, rotationX: 0 },
                ...
                d.find(".slotslide").each(function (t) {
                    ...
                    f.add(
                        punchgs.TweenLite.fromTo(
                            e,
                            y / 1e3,
                            { left: we, rotationX: 40, z: -600, opacity: $, top: 0, scale: 1, force3D: "auto", transformPerspective: 600, transformOrigin: ge, transformStyle: "flat", rotationY: ue },
                ...
                d.find(".slotslide").each(function () {
                    ...
                    f.add(
                        punchgs.TweenLite.fromTo(
                            t,
                            (2 * e) / 1e3,
                            { left: 0, transformStyle: "flat", rotationX: ve, z: 0, autoAlpha: 0, top: 0, scale: 1, force3D: "auto", transformPerspective: 1200, transformOrigin: ge, rotationY: ue },
                            { left: 0, rotationX: 0, top: 0, z: 0, autoAlpha: 1, scale: 1, rotationY: 0, force3D: "auto", delay: e / 1e3, ease: T }
                        ),
                        0
                    );
                }),
                    1 != g
                        ? ((we = -r.width), (ue = 90), 25 == t ? ((ge = "center top 0"), (ve = -ue), (ue = r.rotate)) : ((ge = "left center 0"), (ve = r.rotate)))
                        : ((we = r.width), (ue = -90), 25 == t ? ((ge = "center bottom 0"), (ve = -ue), (ue = r.rotate)) : ((ge = "right center 0"), (ve = r.rotate))),
                    h.find(".slotslide").each(function () {
                        var t = jQuery(this);
                        f.add(
                            punchgs.TweenLite.fromTo(
                                t,
                                y / 1e3,
                                { left: 0, transformStyle: "flat", rotationX: 0, z: 0, autoAlpha: 1, top: 0, scale: 1, force3D: "auto", transformPerspective: 1200, transformOrigin: ge, rotationY: 0 },
                                { left: 0, rotationX: ve, top: 0, z: 0, autoAlpha: 1, force3D: "auto", scale: 1, rotationY: ue, ease: z }
                            ),
                            0
                        );
                    });
                    ...
                    d.find(".slotslide").each(function (t) {
                        ...
                        f.add(
                            punchgs.TweenLite.fromTo(
                                e,
                                y / 1e3,
                                { left: me, rotationX: r.rotate, force3D: "auto", opacity: $, top: 0, scale: 1, transformPerspective: 1200, transformOrigin: ge, rotationY: ue },
                    ...
                    h.find(".slotslide").each(function (e) {
                        ...
                        f.add(
                            punchgs.TweenLite.fromTo(
                                o,
                                y / 1e3,
                                { left: 0, rotationX: 0, top: 0, z: 0, scale: 1, force3D: "auto", transformStyle: "flat", transformPerspective: 1200, transformOrigin: ge, rotationY: 0 },
                                { left: me, rotationX: r.rotate, top: 0, scale: 1, rotationY: ue, delay: (50 * e) / 500, ease: z }
                            ),
                            0
                        ),
