    ...
    jQuery.extend(!0, a, {
        resetVideo: function (e, d) {
            switch (e.data("videotype")) {
                ...
                case "html5":
                    ...
                    var s = e.find("video"),
                        l = s[0];
                    if ((punchgs.TweenLite.to(s, 0.3, { autoAlpha: 1, display: "block", ease: punchgs.Power3.easeInOut }), "on" == e.data("forcerewind") && !e.hasClass("videoisplaying")))
                        try {
                            var o = t(e.data("videostartat"));
        ...
        prepareCoveredVideo: function (e, t, a) {
            var i = a.find("iframe, video"),
                ...
                p = (s / n) * 100;
            n > s
                ? punchgs.TweenLite.to(i, 0.001, { height: l + "%", width: "100%", top: -(l - 100) / 2 + "%", left: "0px", position: "absolute" })
            ...
            switch ((e.data("videotype", T), k)) {
                ...
                case "vimeo":
                    "https:" === location.protocol && (b = "https"),
                        e.data(
                            "videomarkup",
                            '<iframe style="visible:hidden" src="' + b + "://player.vimeo.com/video/" + u + "?" + p + '" webkitallowfullscreen mozallowfullscreen allowfullscreen width="100%" height="100%" style="100%;height:100%"></iframe>'
                        );
            }
                                ...
                                onStateChange: function (e) {
                                    ...
                                    if (e.data == YT.PlayerState.PLAYING)
                                        punchgs.TweenLite.to(p.find(".tp-videoposter"), 0.3, { autoAlpha: 0, force3D: "auto", ease: punchgs.Power3.easeInOut }),
                                            ...
                                            "mute" == p.data("volume") || a.lastToggleState(p.data("videomutetoggledby")) ? c.mute() : (c.unMute(), c.setVolume(parseInt(p.data("volume"), 0) || 75)),
                                            (d.videoplaying = !0),
                                            s(p, d),
                                        ...
                                        if (0 == e.data && v) {
                                            ...
                                            -1 != g && c.seekTo(g), c.playVideo(), a.toggleState(p.data("videotoggledby"));
                                        }
                                        (0 == e.data || 2 == e.data) &&
                            ...
                            if (
                                ...
                                T.addEvent("play", function (t) {
                                    e.data("nextslidecalled", 0),
                                        ...
                                        s(e, d),
                                        u ? d.c.trigger("stoptimer") : (d.videoplaying = !1),
                                        "mute" == e.data("volume") || a.lastToggleState(e.data("videomutetoggledby")) ? T.api("setVolume", "0") : T.api("setVolume", parseInt(e.data("volume"), 0) / 100 || 0.75),
            ...
            void 0 != y &&
                ...
                d(v, "timeupdate", function () {
                    var a = (100 / v.duration) * v.currentTime,
                        ...
                        d = v.currentTime;
                    if ((void 0 != b && (b.value = a), 0 != i && -1 != i && Math.abs(i - d) <= 0.3 && i > d && 1 != e.data("nextslidecalled")))
                        if (c) {
                            v.play();
                            var o = t(e.data("videostartat"));
                            -1 != o && (v.currentTime = o);
                ...
                d(v, "play", function () {
                    e.data("nextslidecalled", 0),
                        ...
                        s(e, r),
                        g
                            ? ((r.videoplaying = !0), r.c.trigger("stoptimer"), r.c.trigger("revolution.slide.onvideoplay", o(v, "html5", e.data())))
                            : ((r.videoplaying = !1), r.c.trigger("starttimer"), r.c.trigger("revolution.slide.onvideostop", o(v, "html5", e.data()))),
                        punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, { autoAlpha: 0, force3D: "auto", ease: punchgs.Power3.easeInOut }),
                        punchgs.TweenLite.to(e.find("video"), 0.3, { autoAlpha: 1, display: "block", ease: punchgs.Power3.easeInOut });
                ...
                d(v, "pause", function () {
                    e.find(".tp-videoposter").length > 0 &&
                        ...
                        (punchgs.TweenLite.to(e.find(".tp-videoposter"), 0.3, { autoAlpha: 1, force3D: "auto", ease: punchgs.Power3.easeInOut }), punchgs.TweenLite.to(e.find("video"), 0.3, { autoAlpha: 0, ease: punchgs.Power3.easeInOut })),
